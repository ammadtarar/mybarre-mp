let localList = {
  ...
  'en': {
    ...
    "t&cTitle": "MYbarre Instructor Training License Terms and Conditions.",
    ...
    "la1": "Non-compete MYbarre Education, Training & License: You are agreeing to a “non compete” to the Instructor Training, meaning that the Recipient shall not own, manage, operate, consult or instruct a business utilising or delivering training for a barre workout program in a manner substantially similar to, or competitive with, the present business of the (MYbarre) Company during the term of this Agreement. On completion of the MYbarre course, passing exam you agree to purchase the annual license purchase where you will become a MYbarre Licensed Instructor. The license grants you the non transferable right to teach MYbarre classes for up to one year (12 months from the date of issue) During this time you will be issued with continued education class plans, choreography and digital training guides that can only be used to deliver the MYbarre core format, this is only to be viewed and used by the License Trainer, sharing videos and training information will be seen as a breach of contract. You will not use any materials or teaching principles you have learned or receive to teach anything except MYbarre class. While a qualified and licensed MYbarre instructor you are not allowed to teach any other barre/ballet fitness class or barre fitness programme.",
    "la2": "Use of name/brand/logo: As a licensed MYbarre instructor you can use the word ‘MYbarre' on studio class schedules and class/marketing communications. It must be displayed using capital ‘MY’ and lowercase ‘barre’. You must pay your Instructor License Fee to MYbarre to keep the license current, if the annual payment is outstanding longer than 30 days the license will be revoked and all rights to teach MYbarre as above and access to the logo, name, trademarks is revoked.",
